                           ...
                           <div class="row">
                               ...
                               <div class="col-lg-4 col-md-6">
                                   <div class="footer-logo">
                                       <img src="<?= base_url(); ?>assets/images/menu/logo/1.png" alt="Footer Logo" width="100px" height="100px">
                                       <p class="info">
                                           ITStore By Muhammad Prasasti Agung
                                       </p>
                                   </div>
                                   <ul class="des">
                                       <li>
                                           <span>Address: </span>
                                           Jl. Kentang Rt 48 Rw 14, Palembang
                                       </li>
                                       <li>
                                           <span>Phone: </span>
                                       ...
                                       <li>
                                           <span>Email: </span>
                                           <a href="mailto://info@itstoreku.com">info@itstoreku.com</a>
                                       </li>
                                   </ul>
                               </div>
